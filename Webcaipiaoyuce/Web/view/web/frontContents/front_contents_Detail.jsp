...
<%--                 <div class="cont">${contents.contents }</div> --%>
                ...
                <div class="add" style="padding-left:450px">开始日期：${fn:substring(opinionPoll.beginDate,0,10)}&nbsp;&nbsp;结束时间：${fn:substring(opinionPoll.endDate,0,10)}</div>
                <c:choose>
                <c:when test="${opinionPoll.isCollect==1 && flag=='now' }">
