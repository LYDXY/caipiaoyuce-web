...
<%-- 	<c:choose>
		<c:when test="${flag=='1'}">
		请选择信箱类型：<select name="flag" id="flag"><option></option><option value="1" selected="selected">市长信箱</option><option value="2">我要写信</option><option value="3">我要建议</option></select> 
		</c:when>
		<c:when test="${flag=='2'}">
		请选择信箱类型：<select name="flag" id="flag"><option></option><option value="1">市长信箱</option><option value="2" selected="selected">我要写信</option><option value="3">我要建议</option></select> 
		</c:when>
		<c:when test="${flag=='3'}">
		请选择信箱类型：<select name="flag" id="flag"><option></option><option value="1">市长信箱</option><option value="2">我要写信</option><option value="3" selected="selected">我要建议</option></select> 
		</c:when>
		<c:otherwise>
		请选择信箱类型：<select name="flag" id="flag"><option></option><option value="1">市长信箱</option><option value="2">我要写信</option><option value="3">我要建议</option></select> 
		</c:otherwise>
	</c:choose> --%>
...
<table id="dg" title="列表" style="width:auto;height:640px" data-options="
    ...
    <tr>
        ...
        <th field="acceptNum" width="160">受理编号</th>
        <th field="name" width="60">姓名</th>
        <th field="theme" width="150">主题</th>
        ...
        <th field="certNum" width="100">身份证号码</th>
        <th field="phone" width="80">联系电话</th>
        <th field="moblePhone" width="80">手机号码</th>
        <th field="email" width="80">邮箱地址</th>
        <th field="address" width="80">联系地址</th>
        <th field="postcode" width="50">邮编地址</th>
        <th field="workplace" width="60">工作单位</th>
        <th field="ipAddress" width="60">用户ip地址</th>
