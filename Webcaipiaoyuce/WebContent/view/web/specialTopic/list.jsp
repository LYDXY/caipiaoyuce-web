...
<%--         <div class="banner"><img src="${ctx}/uploads/zt/pic/${catalog.theID}_banner.jpg" style="height:80px;" /></div> --%>
        	<pg:pager url="${ctx}/web/specialTopicList.action" maxPageItems="15" maxIndexPages="10" export="offset,currentPageNumber=pageNumber" isOffset="false" index="half-full">
