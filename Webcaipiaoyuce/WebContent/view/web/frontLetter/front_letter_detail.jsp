...
<div class="wrapper">
	<div class="inner">
        ...
        <div class="main">
        	<div class="position"><span>当前位置：</span><a href="${ctx}/web/index.action">网站首页</a> > <b><c:if test="${flag eq '1'}">市长信箱</c:if><c:if test="${flag eq '2'}">我要写信</c:if><c:if test="${flag eq '3'}">我要建议</c:if>答复选登</b></div>                 
        ...
        <c:if test="${letterDetail!=null }">
            ...
            <tr>
                <th>涉及单位：</th>
                <td>
                <c:if test="${letterDetail.referDept eq '0' }">
                    未选择
                </c:if>
                <c:if test="${letterDetail.referDept eq '1' }">
                    市交通局
                </c:if>
                <c:if test="${letterDetail.referDept eq '2' }">
                    市农业局
                </c:if>
                <c:if test="${letterDetail.referDept eq '3' }">
                    市住建局
                </c:if>
                <c:if test="${letterDetail.referDept eq '4' }">
                    市国土局
                </c:if>
                <c:if test="${letterDetail.referDept eq '5' }">
                    市人社局
                </c:if>
                <c:if test="${letterDetail.referDept eq '6' }">
                    市财政局
                </c:if>
                <c:if test="${letterDetail.referDept eq '7' }">
                    市民政局
                </c:if>
                <c:if test="${letterDetail.referDept eq '8' }">
                    市科技局
                </c:if>
                <c:if test="${letterDetail.referDept eq '9' }">
                    市教育局
                </c:if>
                <c:if test="${letterDetail.referDept eq '10' }">
                    市经信局
                </c:if>
                <c:if test="${letterDetail.referDept eq '11' }">
                    市编委办
                </c:if>
                <c:if test="${letterDetail.referDept eq '12' }">
                    市林业局
                </c:if>
                <c:if test="${letterDetail.referDept eq '13' }">
                    市人防办
                </c:if>
                <c:if test="${letterDetail.referDept eq '14' }">
                    市城规局
                </c:if>
                <c:if test="${letterDetail.referDept eq '15' }">
                    市水务局
                </c:if>
                <c:if test="${letterDetail.referDept eq '16' }">
                    市外侨局
                </c:if>
                <c:if test="${letterDetail.referDept eq '17' }">
                    普宁烟草专卖局
                </c:if>
                <c:if test="${letterDetail.referDept eq '18' }">
                    市气象局
                </c:if>
                <c:if test="${letterDetail.referDept eq '19' }">
                    普宁供电局
                </c:if> 
                </td>
                <th>联名人数：</th>
