...
var newOpenContents_page = {
	    ...
	    saveNewOpenContents:function(){
            ...
            if(flag){
               var url = "${ctx}/opencontents/saveNewOpenContents.action";
               var param = {};
...
$(function(){
	newOpenContents_page.initInfoTipWin();
...
<div id="newOpenContentsWin" class="easyui-panel" title="新增内容" collapsible="false" minimizable="false"
   ...
   <div id="tb" style="height:auto" class="datagrid-toolbar">
    ...
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
            <form id="newRoleForm" method="post">
                <table class="formtable">
                    ...
                    <tr>
                        <th>文号：</th>
                        <td><input id="conCode" type="text" class="easyui-validatebox" /></td>
                        <th>发布日期：</th>
                        <td>
        ...
        <div region="south" border="false" style="text-align: center; height: 50px; line-height: 50px;">
            <a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onClick="newOpenContents_page.saveNewOpenContents()">
                保存</a> 
        </div>
    </div>
</div>
...
<div id="infoTipWin" class="easyui-window" title="提示信息" collapsible="false" minimizable="false"
    ...
    <div class="easyui-layout" fit="true">
        ...
        <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
            <a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onClick="newOpenContents_page.closeInfoTipWin()">
                确认</a>
        </div>
    </div>
</div>
