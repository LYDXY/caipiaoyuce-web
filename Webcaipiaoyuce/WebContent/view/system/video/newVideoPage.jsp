                ...
                <table class="formtable">
                    <tr>
                        ...
                        <td>
                        	...
                        	<input type="hidden" id="isindex" name="video.isindex" value="0" />
                        </td>
                    </tr>
                    <tr>
...
<!--                     	<td> -->
<!--                     		<input type="file" id="upload" name="upload" size="50"/>（视频格式只能是.flv） -->
<!--                     	</td> -->
<!--                     </tr> -->
                    <tr>
                    	<td><span style="color:red">*</span>视频链接:</td>
                    	<td>
                    		<input type="text" id="url" name="video.url" size="50" />
                    	</td>
                    </tr>
                </table>
