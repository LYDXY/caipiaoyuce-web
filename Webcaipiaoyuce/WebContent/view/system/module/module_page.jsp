...
<script>
    ...
    var module_page = {
        ...
        saveEditModule:function (){
            ...
            if(flag){
                ...
                $.post(url,param,function(data){
                    if(data=="success"){
                        module_page.closeEditModuleWin();
                        var url = "${ctx}/module/moduleList.action";
                        var param = {};
                        param.moduleLevel = "1";
                        $.post(url,param,function(data){
        ...
        deleteModule:function (){
            ...
            $.post(url,param,function(data){
                if(data=="success"){
                    module_page.closeDeleteModuleWin();
                    var url = "${ctx}/module/moduleList.action";
                    var param = {};
                    param.moduleLevel = "1";
                    $.post(url,param,function(data){
    ...
    $(function(){
        ...
        //初始化新建窗口
        module_page.initNewModuleWin();
        //绑定事件
        $('#addModuleBtn').click(function() {
            $('#newModuleWin').window('open');
        });

        module_page.initEditModuleWin();
        ...
        module_page.initDeleteModuleWin();
        ...
        module_page.initInfoTipWin();

        $('#editSubModuleBtn').click(function() {
            if($("#id_edit").val()==""){
                return;
            }
            window.location.href = "${ctx}/module/subModulePage.action?id="+$("#id_edit").val();
        });
...
<table id="dg" title="模块列表" style="width:700px;height:640px" data-options="
				rownumbers:true,
				singleSelect:true,
				autoRowHeight:false,
				toolbar: '#tb',
				pagination:true,
				pageSize:20,
				onClickRow: module_page.onClickRow">
    <thead>
    <tr>
        <th field="id" width="100">模块编号</th>
        <th field="moduleName" width="100">模块名称</th>
        <th field="moduleCode" width="100">模块编码</th>
...
<div id="tb" style="height:auto">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" id="editSubModuleBtn">编辑子模块</a>
</div>


<div id="newModuleWin" class="easyui-window" title="新建模块" collapsible="false" minimizable="false"
    ...
    <div class="easyui-layout" fit="true">
        ...
        <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
            <a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onclick="module_page.saveNewModule()">
                保存</a> <a class="easyui-linkbutton" icon="icon-cancel" href="javascript:void(0)"
                          onclick="module_page.closeNewModuleWin()">取消</a>
        </div>
    </div>
</div>


<div id="editModuleWin" class="easyui-window" title="编辑模块" collapsible="false" minimizable="false"
     maximizable="false" icon="icon-save"  style="width: 300px; height: 250px; padding: 5px;
        background: #fafafa;" data-options="left:'250px',top:'200px'">
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
        ...
        <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
            <a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onclick="module_page.saveEditModule()">
                保存</a> <a class="easyui-linkbutton" icon="icon-cancel" href="javascript:void(0)"
                          onclick="module_page.closeEditModuleWin()">取消</a>
        </div>
    </div>
</div>


<div id="deleteModuleWin" class="easyui-window" title="删除模块" collapsible="false" minimizable="false"
     maximizable="false" icon="icon-save"  style="width: 300px; height: 250px; padding: 5px;
        background: #fafafa;" data-options="left:'250px',top:'200px'">
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
        ...
        <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
            <a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onclick="module_page.deleteModule()">
                确认</a> <a class="easyui-linkbutton" icon="icon-cancel" href="javascript:void(0)"
                          onclick="module_page.closeDeleteModuleWin()">取消</a>
        </div>
    </div>
</div>
...
<div id="infoTipWin" class="easyui-window" title="提示信息" collapsible="false" minimizable="false"
    ...
    <div class="easyui-layout" fit="true">
        ...
        <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
            <a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onclick="module_page.closeInfoTipWin()">
                确认</a>
        </div>
    </div>
</div>
