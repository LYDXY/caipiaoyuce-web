...
<script>
    ...
    var catalog_page = {
        ...
        zlsaveNewCatalog:function (){
            ...
            if(flag){
                var url = "${ctx}/zlcatalog/zlsaveNewCatalog.action";
                var param = {};
                ...
                $.post(url,param,function(data){
                    if(data=="success"){
                        ...
                        $("#sort").val("");
                        $("#url").val("");
                        var url = "${ctx}/zlcatalog/zlcatalogList.action";
                        var param = {};
                        param.parentID = $("#parentID").val();
                        $.post(url,param,function(data){
        ...
        zlsaveEditCatalog:function (){
             ...
             if(flag){
                var url = "${ctx}/zlcatalog/zlsaveEditCatalog.action";
                var param = {};
                ...
                $.ajaxFileUpload({
                    url:'${ctx}/zlcatalog/zluploader.action?theID='+$("#theID_edit").val(),            //需要链接到服务器地址
                    secureuri:false,
        ...
        zldeleteCatalog:function (){
        	 if($("#theID_delete").val()==""){
                 return;
             }
            var url = "${ctx}/zlcatalog/zldeleteCatalog.action";
            var param = {};
...
<td valign="top" width="170">
	<iframe src="${ctx}/view/system/zlcatalog/zlcatalogZTree.jsp" height="600" width="170" frameborder="0" scrolling="auto" id="leftframe"></iframe>
</td>
                    ...
                    <tr>
                        ...
                        <td>
                        	<select id="catalogType" onChange="changeValue(this.value)">
                        		...
                        		<option value="t_contents" selected="selected">文章页面</option>
                        		<!-- <option value="t_video">视频页面</option>-->
                        		<option value="t_links">跳转页面</option>
...
<!--                         		<option value="t_specialTopic">专题报道</option> --> 
        ...
        <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
            <a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onClick="catalog_page.zlsaveNewCatalog()">
...
<!--                         		<option value="t_specialTopic">专题报道</option> -->
        ...
        <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
            <a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onClick="catalog_page.zlsaveEditCatalog()">
                保存</a> <a class="easyui-linkbutton" icon="icon-cancel" href="javascript:void(0)"
...
<div id="deleteCatalogWin" class="easyui-window" title="删除栏目" collapsible="false" minimizable="false"
    ...
    <div class="easyui-layout" fit="true">
        ...
        <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
            <a class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0)" onClick="catalog_page.zldeleteCatalog()">
