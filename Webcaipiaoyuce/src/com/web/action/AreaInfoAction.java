...
public class AreaInfoAction extends BaseAction {
    ...
    public String areaInfoPage() {
        ...
        String pnfjCatalogID  = PropertiesUtils.readValue(propertiesPath, "pnfjCatalogID");
        fiParam.setFileMode("t_fileinfo");
        fiParam.setFileType("1");
        fiParam.setIsshow("1");
        fiParam.setCatalogID(Integer.valueOf(pnfjCatalogID));
...
//		}
    ...
    public String areaInfoMainList() {
        ...
        this.initTheTitle(catalog,request.getParameter("type"));
...
//				List<Contents> contentsList = frontContentsServices.queryContentsListByBean(contents);
        ...
        if(type != null){
        	if(type.equals("announcement")){
        		request.setAttribute("leftTitle", "announcement");
        		return "annList";
        	}else{
        		this.initTheTitle(catalog,request.getParameter("type"));
        	}
    ...
    public String contentsShow() {
        ...
        if(type != null){
        	if(type.equals("announcement")){
        		...
        		this.initTheTitle(catalog,type);
        	}
        }
    ...
    private void initTheTitle(Catalog catalog,String type) {
        //左导航标题和当前位置的标题（临时方法）
       // String type = request.getParameter("type");
        String contentTitle = "";
        if (type != null) {
