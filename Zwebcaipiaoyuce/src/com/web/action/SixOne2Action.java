 ...
 *         2015年12月12日
 */
public class SixOne2Action extends BaseAction {

	private String TAG = "SixOne2Action";
	private static final long serialVersionUID = 1L;
	private static final int List = 0;

	@Resource(name = "SixOne2Services") // 接口的实现
	private SixOneServices SixOne2Services; // 服务层的接口
