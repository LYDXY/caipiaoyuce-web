		...
		<tbody class="info">
			<tr>
				...
				<td><h5>
						...
						<br>
						<br> (3)层叠 :举个例子来说，某个数字可能遗漏 3期，然后中奖一次；再遗漏5
						期，然后又中奖一次；接着，又遗漏20或 30期彩票，直到出现间隔3
						期或3期以下遗漏的标准期趋势逆转，才标志着一个层叠模式的终结。经过这一过程之后，这个数字会热门起来。<br>
						<br>
						<br>
						(4)反向层叠:指的是在两次中奖之间在持续时间上递减的遗漏时段情况。这种层叠通常表明，某个数字正在接近终结其下滑趋势，而变成一个热门数字。<br>
						<br>
						<br> (5)双底:如果某个数字在双底之后遗漏了2期或3期，你就应该放弃对这个数字的选择。<br>
						<br>
						<br> (6)旗式排列:一个典型的旗式排列，在你的彩票期数表当中看起来是这样的X2X5X5X
						,,,XX5,,,X1X5,,,X2X5
